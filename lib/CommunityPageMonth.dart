...
class CommunityPageMonth extends StatelessWidget {
  CommunityPageMonth({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_s4sl6v =
    '<svg viewBox="208.5 126.5 63.0 1.0" ><path transform="translate(208.5, 126.5)" d="M 0 0 L 63 0" fill="none" stroke="#363e75" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
