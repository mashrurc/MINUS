...
class CommunityPageAllTime extends StatelessWidget {
  CommunityPageAllTime({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(161.0, 192.0),
            child:
                // Adobe XD layer: 'Image 7' (shape)
                Container(
              width: 98.0,
              height: 101.0,
              decoration: BoxDecoration(
...
const String _svg_dnco51 =
    '<svg viewBox="313.5 128.5 78.0 1.0" ><path transform="translate(313.5, 128.5)" d="M 0 0 L 78 0" fill="none" stroke="#363e75" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
