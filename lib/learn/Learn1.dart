    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(13.0, 502.0),
            child: SizedBox(
              width: 388.0,
              height: 131.0,
              child: Text(
                'The American Forest Foundation (AFF) works on-the-\nground with families, partners and elected officials to \npromote forest stewardship and protect our nation’s \nforest heritage. A commitment to the next generation \nunites our nationwide network of forest owners working \nto keep our forests healthy and producing the clean \nwater, wildlife habitat and sustainable wood supplies \nthat all Americans count on from forests.',
                style: TextStyle(
                  fontFamily: 'Averta Standard',
                  fontSize: 15,
                  color: const Color(0xffffffff),
