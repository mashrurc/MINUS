...
import './PaymentPage5.dart';
import './PaymentPage4.dart';
import './Offset2.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-11.0, 128.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeOut,
                  duration: 0.6,
                  pageBuilder: () => PaymentPage5(),
                ),
              ],
              child: Container(
                width: 105.0,
          ...
          Transform.translate(
            offset: Offset(321.0, 142.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeOut,
                  duration: 0.6,
                  pageBuilder: () => PaymentPage4(),
                ),
              ],
              child: Container(
                width: 110.0,
